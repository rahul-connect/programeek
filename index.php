...
<div class="row">
  ...
  <div class="hide-on-med-and-up" style="margin-bottom:20px;">
     <h4 class="center teal-text">Latest Posts</h4><hr>
	</div>
	   
	   	<?php
		
	    $fetch_post = mysqli_query($con,"SELECT id,title,category,image,slug,views,date_created FROM blog WHERE status = '1' ORDER BY id DESC LIMIT $start,$per_page");
	 ...
	 <div class='card-image'>
        <img src='images/placeholder.png' data-src='images/$image' class='responsive-img' alt='$title' style='height:100%;width:100%;'>
      </div>
	 ...
	 <div class='card-content' style='padding-bottom:0;'>
	  ...
	  <div class='card hoverable'>
	      <div class='card-image'>
        <img src='images/placeholder.png' data-src='images/$image' class='responsive-img' alt='$title' style='height:200px;width:100%;'>
	...
	?>
	 ...
	 <?php
         if($page < 2){
			 ...
			 $back = $page-1;
			 echo "<li class='waves-effect'><a href='index.php?page=$back'><i class='material-icons'>chevron_left</i></a></li>";
		 }
		 ...
		 for($i = 1;$i<=$total_pages;$i++){
		   ...
		   if($page == $total_pages){
			 ...
			 $next = $page+1;
			 echo "<li class='waves-effect'><a href='index.php?page=$next'><i class='material-icons'>chevron_right</i></a></li>";
		 }
